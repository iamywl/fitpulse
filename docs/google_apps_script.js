...
function getFitPulseSurveyPayload() {
  return {
    ...
    description: "안녕하세요! 토스 디자인 시스템(TDS Mobile) 감성의 점진적 과부하 스마트 헬스 트래커 FitPulse(핏펄스) 베타테스트에 참여해 주셔서 진심으로 감사드립니다.\n\n본 설문은 헬스장 환경에서의 TDS UI/UX 사용성, 분할 루틴, 원터치 세트 기록 및 타이머 HUD, 16주 토스 블루 잔디 히트맵, 인바디 맞춤 중량 추천기의 완성도를 평가하기 위한 순수 비영리 프로젝트 연구입니다.\n\n⏱️ 소요 시간: 약 3분 내외 (익명 설문)\n💡 여러분의 솔직한 피드백은 헬스인들이 가장 쓰기 편한 서비스를 만드는 데 온전히 반영됩니다.",
    questions: [
      // [섹션 1] 응답자 운동 프로필
      {
        type: "PAGE_BREAK",
      ...
      {
        type: "SECTION_HEADER",
        title: "💌 정식 출시 및 업데이트 소식 알림 (선택 사항)",
        helpText: "FitPulse의 정식 출시 소식이나 기능 업데이트를 가장 먼저 받아보고 싶으신 분만 이메일을 남겨주세요 (원치 않으시면 비워두셔도 됩니다)."
      },
      {
        type: "TEXT",
        title: "이메일 주소 (선택)",
